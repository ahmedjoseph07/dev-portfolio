...
const About = () => {
    return (
        <div
            id="about"
            className="w-full px-4 py-20 scroll-mt-20">
            <h4
            ...
            <div
                className="flex w-full flex-col items-center justify-center gap-20 my-20">
                <div
                    ...
                    <div className="relative">
                        ...
                        <div className="w-64 z-40 sm:w-56 rounded-full max-w-none p-1">
                            <Image
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl leading-7 text-md text-center text-gray-500">
                        ...
                        , and creating{" "}
                        <span className="font-bold">secure APIs</span>,
                        while also being capable of delivering{" "}
                        <span className="font-bold">
                        ...
                        and <span className="font-bold">optimization</span>,
                        I strive to build{" "}
                        <span className="font-bold">
